...
3. Give the bot a handle (ex: `rollBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://ds-roll-dice.azurewebsites.net/api/messages`
